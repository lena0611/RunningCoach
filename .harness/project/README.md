...
5. [사업화 검토](./business-review.md)
6. [로컬 개발방법론](./local-methodology.md)
7. [개발 기준 계층](./standards-layers.md)
8. [개인 개발 기준 예시](./personal-methodology.example.md)
...
15. [중요 경로 선언](./critical-paths.md)
16. [설정 계약](./config-contract.md)
17. [이식 가이드](./portability-guide.md)
18. [스택 프리셋 목록](../stacks/README.md)
