...
- 심박 존은 개인 최대심박/역치심박이 입력되기 전까지 현재 사용자 확인 기준을 기본값으로 쓴다. Z1 회복은 130bpm 이하, Z2 이지는 131~145bpm, Z3 이지 상단/스테디 초입은 146~155bpm, Z4 템포는 156~165bpm, Z5 고강도는 166bpm 이상이다. 개인 max HR, threshold HR, lactate threshold 같은 기준값이 생기면 이 기본값보다 개인화 존을 우선한다.
