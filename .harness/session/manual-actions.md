...
| open | 하네스 본체 개선요청 — `harness:update`가 소비자 `CLAUDE.md` 무단 덮어쓰기 | harness-seed 메인테이너에게 전달. 요청서: `.harness/session/harness-body-improvement-request-claude-md-overwrite.md`. 본체 수정이라 소비자 repo에선 적용 불가. | 2026-06-15 base 0.2.64 업데이트 |
