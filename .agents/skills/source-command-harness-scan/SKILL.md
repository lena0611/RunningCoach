---
name: "source-command-harness-scan"
description: "현재 프로젝트를 스캔하고 로컬 기준 후보와 충돌 후보를 정리합니다."
---

# source-command-harness-scan

Use this skill when the user asks to run the migrated source command `harness-scan`.

## Command Template

# /harness-scan

이 명령은 Codex 어댑터용 프로젝트 스캔 절차입니다. 기준 산출물은 `.Codex/`가 아니라 `.harness/`입니다.

## 0. 사전 점검
1. `AGENTS.md`를 읽고 지정된 순서의 `.harness/` 문서를 확인합니다.
