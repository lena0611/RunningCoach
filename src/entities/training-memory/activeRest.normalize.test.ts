...
describe('normalizeActiveRest (#473)', () => {
  it('유효한 휴식 메타는 보존한다', () => {
    ...
    ).toEqual({ startDate: '2026-06-22', untilDate: '2026-06-28', reason: 'injury', declaredAt: '2026-06-22T01:00:00.000Z' })
  })
  ...
  it('이상 reason 은 other 로, declaredAt 누락은 startDate 자정으로 보정', () => {
    ...
    expect(out).toEqual({ startDate: '2026-06-22', untilDate: '2026-06-28', reason: 'other', declaredAt: '2026-06-22T00:00:00.000Z' })
  })
