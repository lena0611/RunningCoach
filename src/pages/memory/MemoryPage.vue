  ...
  <section class="page memory-page">
    <SectionCard>
      <div class="section-heading">
        <div>
          <button v-if="panel !== 'overview'" class="ghost compact-action" type="button" @click="panel = panel === 'goal-edit' || panel === 'goal-new' ? 'goals' : panel === 'injury-edit' || panel === 'injury-new' ? 'injuries' : 'overview'">
            뒤로
          </button>
          <h2>코칭 메모리</h2>
        </div>
      ...
      <div v-else-if="panel === 'goals'" class="memory-stack">
